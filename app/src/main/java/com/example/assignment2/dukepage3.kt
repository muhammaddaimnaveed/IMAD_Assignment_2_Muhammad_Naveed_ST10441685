...
class dukepage3 : AppCompatActivity() {
    // declared the variables.

    private lateinit var progressBar: ProgressBar
    private lateinit var playbuttonk: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_dukepage3)
...
// declared the variables.
        ...
        playbuttonk = findViewById(R.id.playbuttonk)

// progress bar placed to increases the progress bar level.

        playbuttonk.setOnClickListener {
        ...
        var backbuttonk = findViewById<Button>(R.id.backbuttonk)
